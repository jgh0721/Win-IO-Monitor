#ifndef HDR_FLT_CMNLIBS_RING_BUFFER
#define HDR_FLT_CMNLIBS_RING_BUFFER

/*!
	This code was ported from Github( Windows-Sensor project )
*/
...
#endif // HDR_FLT_CMNLIBS_RING_BUFFER